    ...
    <div className="snap-y snap-mandatory overflow-y-scroll overflow-x-hidden h-screen w-screen text-white">
      ...
      <Section>
        ...
        <div className="flex flex-col gap-4 sm:gap-6 md:gap-8">
          <h3 className="lg:text-6xl md:text-5xl smallPhone:text-4xl text-3xl font-bold">
            To overwhelm with an abundance of something.
          </h3>
          <p className="text-xl custom1:text-2xl smallPhone:text-3xl md:text-3xl lg:text-4xl leading-relaxed max-w-[48rem] font-medium font-hero">
